...
fn stabilizer(x: f32, y: f32, s: f32) -> [[[f32; 2]; 2]; 13] {
    return [
        [[x, y], [x + 8.3, y]],
        [[x + 8.3, y], [x + 8.3, y - 32.3]],
        [[x + 8.3, y - 32.3], [x + 25.5, y - 32.3]],
        [[x + 25.5, y - 32.3], [x + 25.5, y - 41.5]],
        [[x + 25.5, y - 41.5], [x + 58.5, y - 41.5]],
        [[x + 58.5, y - 41.5], [x + 58.5, y - 32.3]],
        [[x + 58.5, y - 32.3], [x + 75.7, y - 32.3]],
        [[x + 75.7, y - 32.3], [x + 75.7, y]],
        [[x + 75.7, y], [x + 89.0 + s, y]],
        [[x + 89.0 + s, y], [x + 89.0, y - 6.]],
        [[x + 89.0, y - 6.], [x + 81.0, y - 6.]],
        [[x + 81.0, y - 6.], [x + 81.0, y - 37.]],
        [[x + 81.0, y - 37.], [x + 89.0, y - 37.]],
    ];
}
